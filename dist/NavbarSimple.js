...
}, items.map(item => /*#__PURE__*/React.createElement(StyledNavLink, {
  color: colorLink,
  colorActive: colorLinkActive,
  to: item.to
}, /*#__PURE__*/React.createElement(StyledNavLinkIcon, {
  className: "material-icons"
}, item.icon), /*#__PURE__*/React.createElement(StyledNavLinkText, null, item.text))));
